{{-- NGATUR BAGIAN VIEW --}}
{{-- coba bikin custom tampilan register --}}
<!DOCTYPE html>
    ...
    <div class="container-xxl">
      <div class="authentication-wrapper authentication-basic container-p-y">
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Restaurant register</span>
                </a>
              </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-3">
              <label for="usertype" value="{{ __('Usertype') }}" class="form-label">Role (0=User | 1=Admin)</label>
              <input
                type="text"
                class="form-control"
                id="usertype"
            ...
            <div class="mb-3">
              <label for="password_confirmation" value="{{ __('Confirm Password') }}" class="form-label">Pasword Confirmation</label>
              <input
                type="password"
                class="form-control"
