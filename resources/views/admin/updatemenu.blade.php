                        ...
                        <div class="col-xxl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ url('berhasil_update_menu',$data->id) }}" method="POST"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="nama"
                                                    placeholder="Nama Menuu...." name="nama" {{-- jangan lupa dikasih value session biar otomatis keisi sama inputan sebelumnya --}}
                                                    value="{{ $data->nama }}" {{-- jangan lupa dikasih required agar jika ada perintah harus diisi dan tidak boleh kosong  --}} required="" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label" for="basic-default-company">Deskripsi
                                                Menu</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="deskripsi" class="form-control"
                                                    id="deskripsi" placeholder="Deskripsi Menu....."
                                                    {{-- jangan lupa dikasih required agar jika ada perintah harus diisi dan tidak boleh kosong  --}} required="" {{-- jangan lupa dikasih value session biar otomatis keisi sama inputan sebelumnya --}}
                                                    value="{{ $data->deskripsi }}" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label"
                                                for="basic-default-email">Harga</label>
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    <input type="text" id="harga" name="harga"
                                                        class="form-control" placeholder="Harga Menu...."
                                                        {{-- jangan lupa dikasih required agar jika ada perintah harus diisi dan tidak boleh kosong  --}} required="" {{-- jangan lupa dikasih value session biar otomatis keisi sama inputan sebelumnya --}}
                                                        value="{{ $data->harga }}" />
                                                </div>
                                            </div>
                                                ...
                                                <div class="row mb-3">
                                                    <label class="col-sm-2 col-form-label"
                                                        for="basic-default-email">Foto Lama</label>
                                                    <div class="col-sm-10">
                                                        <div class="input-group input-group-merge">
                                                            <img style="max-height: 200px;max-width: 250px"
                                                                src="{{ url('featured_image') . '/' . $data->foto }}"
                                                                alt="">
                                                        </div>
                                                        {{--  --}}
                                                ...
                                                <div class="row mb-3">
                                                    <label class="col-sm-2 col-form-label"
                                                        for="basic-default-phone">Ganti Foto</label>
                                                    <div class="col-sm-10">
                                                        <input type="file" name="foto" id="basic-default-phone"
